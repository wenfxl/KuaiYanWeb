  ...
  let 图数据 = {
    ...
    tooltip: {
      ...
      formatter: function (params) {
        ...
        return dotColor + '非会员:' + params[0].value[1].toString() + "(" + (params[0].value[1] / (params[0].value[1] + params[0].value[2]) * 100).toFixed(2).toString() + "%)" + "<br>" +
            dotColor2 + '会员:' + params[0].value[2].toString() + "(" + (params[0].value[2] / (params[0].value[1] + params[0].value[2]) * 100).toFixed(2).toString() + "%)" + "<br>" +
