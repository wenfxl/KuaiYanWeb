<template>
  <el-badge :value="Store.state.UserInfo.UserMsgNoRead" :max="99" class="item"  :hidden="Store.state.UserInfo.UserMsgNoRead===0">
    <el-icon class="右上角图标"  @click="on路由跳转('用户消息')"><Bell /></el-icon>
  </el-badge>
